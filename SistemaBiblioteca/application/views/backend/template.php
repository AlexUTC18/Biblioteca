...
<head>
	...
	<title>Gestion de biblioteca - <?php echo $title; ?></title>
...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="<?php echo base_url(); ?>backend/dashboard" class="logo">
			...
			<span class="logo-lg"><b>Gestion de Bibioteca</b></span>
		</a>
			...
			<ul class="sidebar-menu">
				...
				<li class="<?php echo $this->uri->segment(2) === "prestamos" ? 'active' : '' ?> treeview">
		          	...
		          	<ul class="treeview-menu">
		            	...
		            	<li class="<?php echo $this->uri->segment(3) === "pending" ? 'active' : '' ?>"><a href="<?php echo base_url(); ?>backend/prestamos/pending"><i class="fa fa-circle-o"></i> En Prestamo</a></li>
	...
	<footer class="main-footer">
		...
		<strong>Copyright &copy; 2021 .</strong> Desarrollador_Alex Andaluz
	</footer>
